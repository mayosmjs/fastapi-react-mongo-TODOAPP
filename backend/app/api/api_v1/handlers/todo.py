...
from api.dependencies.userDependencies import get_current_user
...
@todo_router.get('/{todo_id}', summary="Get a todo by todo id", response_model=TodoOut)
...
@todo_router.put('/{todo_id}', summary="Update todo by todoid", response_model=TodoOut)
...
@todo_router.delete('/{todo_id}', summary="Delete todo by todo id")
