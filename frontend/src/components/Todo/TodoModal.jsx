  ...
  export const TodoModal = ({
    ...
    return (
      <Box {...rest}>
        ...
        <Button w="100%" colorScheme="purple" onClick={onOpen} variant="ghost">
          {editable ? "Update the task" : "Add a task"} 
        </Button>
...
>
              ...
              <ModalBody>
                ...
                {/* <FormControl isInvalid={errors.datet}>
                  <Input
                    background={useColorModeValue("gray.300", "gray.600")}
                    type="date"
                    variant="filled"
                  ...
                  />
                  <FormErrorMessage>
                    {errors.datet && errors.datet.message}
                  </FormErrorMessage>
                </FormControl> */}
